  ...
  def loop(self,event):
    ...
    if ((self.targets.trialType == 'EL') or (self.targets.trialType == 'CL')):
        if( (self.targets.state == 'target' )):
            if (self.robotshot):
                self.ser.write("!"+str(self.outPosition)+","+str(self.inPosition)+str(1)+","+str(0)+"\r\n")
            else:
                self.ser.write("!"+str(self.outPosition)+","+str(self.inPosition)+str(0)+","+str(0)+"\r\n")
        else:
            self.ser.write("!"+str(self.inPosition)+","+str(self.inPosition)+str(0)+","+str(0)+"\r\n")
    elif ((self.targets.trialType == 'ER') or (self.targets.trialType == 'CR')):
        if( (self.targets.state == 'target' )):
            if(self.robotshot):
                self.ser.write("!"+str(self.inPosition)+","+str(self.outPosition)+str(0)+","+str(0)+"\r\n")
            else:
                self.ser.write("!"+str(self.inPosition)+","+str(self.outPosition)+str(0)+","+str(0)+"\r\n")
        else:
            self.ser.write("!"+str(self.inPosition)+","+str(self.inPosition)+str(0)+","+str(0)+"\r\n")
